...
namespace ImprovedTimers {
    /// <summary>
    /// Timer that counts down from a specific value to zero and can be reversed to count back up to the initial value.
    /// </summary>
    public class ReversableCountdownTimer : Timer {
        public ReversableCountdownTimer(float value) : base(value) { }
